...
import { NgxSpinnerService } from 'ngx-spinner';
    @Component({
      selector: 'app-finalPayment.component',
      ...
      getVerifiedTrans(traxId){
        this.service.getverified(traxId).subscribe(
          (res:any) =>{
            ...
            if(res.data.aitAmount){
              this.service.paymentFormModel.controls['aitAmount'].setValue(res.data.aitAmount);
            }else{
              this.service.paymentFormModel.controls['aitAmount'].setValue(res.data.amount);
            }
