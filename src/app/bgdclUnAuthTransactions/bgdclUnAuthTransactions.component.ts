...
@Component({
  selector: 'bgdclUnAuthTransactions',
  templateUrl: './bgdclUnAuthTransactions.component.html',
  styles: []

  
})
export class BgdclUnAuthTransactionsComponent implements OnInit {
  Transactions: any[];
...
authorize(id){
    ...
    this.router.navigate(['/home/bgdclFinalPayment'], { queryParams: { TransactionId: id } });
