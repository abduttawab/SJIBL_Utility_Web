...
@Component({
  selector: 'app-stage-branch-manager',
  templateUrl: './stage-branch-manager.component.html',
  styles: []
})
export class StageBranchManager implements OnInit {
 ...
 this.getData();
  ...
  onSearch() {
    this.service.search("22ab2cc8-eecc-4ea6-bfeb-52c70de2754a").subscribe(
      (res: any) => {
...
getData(){
  this.service.getApplicationsWithStatusId("22ab2cc8-eecc-4ea6-bfeb-52c70de2754a").subscribe(
    (res:any) =>{
      console.log(res);
