...
import { BREBPaymentService } from 'src/app/shared/BREBPayment.service';
    @Component({
      selector: 'app-BREBVerify.component',
      templateUrl: './BREBVerify.component.html',
      styles: []
    })
    export class BREBVerifyComponent implements OnInit {
      Districts = [];
      BranchList = [];
      SourceByList = [];
      SalesAgentList = [];
              ...
              this.service.verify_Payment().subscribe(
                (res: any) => {
                  ...
                  if (res.isSuccessfull) {
                    ...
                    this.router.navigate(['/home/BREBFinalPayment'], { queryParams: { TransactionId: res.data } });
                    this.spinner.hide();
