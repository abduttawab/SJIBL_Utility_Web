...
@Component({
  selector: 'BREBUnAuthTransactions',
  templateUrl: './BREBUnAuthTransactions.component.html',
  styles: []

  
})
export class BREBUnAuthTransactionsComponent implements OnInit {
  Transactions: any[];
...
authorize(id){
    ...
    this.router.navigate(['/home/BREBFinalPayment'], { queryParams: { TransactionId: id, IsAuth:'Yes' } });
