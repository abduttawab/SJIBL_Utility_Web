...
@Component({
  selector: 'BKASHUnAuthTransactions',
  templateUrl: './BKASHUnAuthTransactions.component.html',
  styles: []

  
})
export class BKASHUnAuthTransactionsComponent implements OnInit {
  Transactions: any[];
...
authorize(id){
    ...
    this.router.navigate(['/home/BKASHFinalPayment'], { queryParams: { TransactionId: id } });
