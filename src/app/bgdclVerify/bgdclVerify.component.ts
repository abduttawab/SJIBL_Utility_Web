...
import { NgxSpinnerService } from 'ngx-spinner';
    @Component({
      selector: 'app-bgdclVerify.component',
      templateUrl: './bgdclVerify.component.html',
      styles: []
    })
    export class bgdclVerifyComponent implements OnInit {
      Districts = [];
      BranchList = [];
      SourceByList = [];
      SalesAgentList = [];
      ...
      // this.service.setMeterValidators();
       this.service.setBPOValidators();
       this.service.set_34_Validators();
       this.service.set_35_Validators();
       this.service.set_37_Validators();
       this.service.set_38_Validators();
       this.service.set_43_Validators();
        ...
        this.commonService.getUtilityType().subscribe(
          (res:any) =>{
            ...
            this.UtilityTypes = Object.assign([], this.UtilityTypes).filter(
              item => item.companyShortCode.indexOf("BGDCL") > -1
           );
              ...
              this.service.verify_Payment().subscribe(
                (res: any) => {
                  ...
                  if (res.isSuccessfull) {
                    ...
                    this.router.navigate(['/home/bgdclFinalPayment'], { queryParams: { TransactionId: res.data } });
                    this.spinner.hide();
                    this.toastr.warning('Data Verified!', 'Operation successfull.');
