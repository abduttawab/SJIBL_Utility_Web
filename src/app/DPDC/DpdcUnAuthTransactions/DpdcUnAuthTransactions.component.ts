...
@Component({
  selector: 'DpdcUnAuthTransactions',
  templateUrl: './DpdcUnAuthTransactions.component.html',
  styles: []

  
})
export class DpdcUnAuthTransactionsComponent implements OnInit {
  Transactions: any[];
...
authorize(id){
    ...
    this.router.navigate(['/home/DpdcFinalPayment'], { queryParams: { TransactionId: id } });
