...
import { NgxSpinnerService } from 'ngx-spinner';
    @Component({
      selector: 'app-nonMpayment.component',
      templateUrl: './nonMpayment.component.html',
      styles: []
    })
    export class NonMpaymentComponent implements OnInit {
      Districts = [];
      BranchList = [];
      SourceByList = [];
      SalesAgentList = [];
        ...
        this.commonService.getUtilityType().subscribe(
          (res:any) =>{
            ...
            this.UtilityTypes = Object.assign([], this.UtilityTypes).filter(
              item => item.companyShortCode.indexOf("KGDCL") > -1
           );
    ...
    this.service.verify_Payment().subscribe(
      (res: any) => {
        ...
        if (res.isSuccessfull) {
          ...
          this.router.navigate(['/home/finalPayment'], { queryParams: { TransactionId: res.data } });
