...
@Component({
  selector: 'DescoUnAuthTransactions',
  templateUrl: './DescoUnAuthTransactions.component.html',
  styles: []

  
})
export class DescoUnAuthTransactionsComponent implements OnInit {
  Transactions: any[];
...
authorize(id){
    ...
    this.router.navigate(['/home/DescoFinalPayment'], { queryParams: { TransactionId: id } });
