  ...
  getVerifiedTrans(traxId) {
    this.service.getverified(traxId).subscribe(
      (res: any) => {
        ...
        if(res.data.nescoTransactionInfo){
          this.service.paymentFormModel.controls['BillNo'].setValue(res.data.nescoTransactionInfo.billNo);
          this.service.paymentFormModel.controls['ConsumerNo'].setValue(res.data.nescoTransactionInfo.consumerNo);
          this.service.paymentFormModel.controls['Year'].setValue(res.data.nescoTransactionInfo.year);
          this.service.paymentFormModel.controls['Month'].setValue(res.data.nescoTransactionInfo.month);
