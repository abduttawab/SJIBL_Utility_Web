...
@Component({
  ...
  templateUrl: './stage-irmd-head.component.html',
  styles: []
})
export class StageIRMDHeadComponent implements OnInit {
...
getData(){
  this.service.getApplicationsWithStatusId("88d88b87-6fdd-49d7-b7b9-077ded560470").subscribe(
    (res:any) =>{
      console.log(res);
