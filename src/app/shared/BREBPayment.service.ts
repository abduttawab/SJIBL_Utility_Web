...
export class BREBPaymentService {
  ...
  constructor(private fb: FormBuilder,
    ...
    @Inject(APP_CONFIG) private config: AppConfig) {
     ...
     readonly BaseConrtURI = this.config.apiEndpoint+'BREB/';
  ...
  removePayByBillValidators() {
    const SMSAccountNo = this.paymentFormModel.get('SMSAccountNo');
    SMSAccountNo.setValidators(null);
  }
  ...
  this.paymentFormModel.get('PaymentTypeId').valueChanges
    .subscribe(PaymentTypeId => {
      ...
      if (PaymentTypeId === '813b6a80-155a-4744-b462-c0bc1a56eae5') {
        SMSAccountNo.setValidators([Validators.required]);

        SMSAccountNo.updateValueAndValidity();
  ...
  ChequeOrSlipDate=this.paymentFormModel.value.ChequeOrSlipDate.day+'-'
    ...
    try {
      var body = {
        ...
        SMSAccountNo: this.paymentFormModel.value.SMSAccountNo,
   ...
   final_Payment() {
    ...
    try {
      var body = {
        ...
        SMSAccountNo: this.paymentFormModel.getRawValue().SMSAccountNo,
...
//
  ...
  getverifiedAuth(trxId) {
    return this.http.get(this.BaseConrtURI + 'GetVerifiedTrxForAuth?trxId=' + trxId);
  }
  getDashboardVM(){
...
+this.searchFormModel.value.ToDate.month+'-'
 + this.searchFormModel.value.ToDate.day;
  ...
  GetDateWiseReportBREBPostPaids() {
      ...
      this.SearchToDate=('0'+this.reportModel.value.ToDate.day).slice(-2)+'-'
            +('0'+this.reportModel.value.ToDate.month).slice(-2)+'-'
             ...
             return this.http.get(this.BaseConrtURI +
               'GetDateRangeWiseReportBREBPostPaids?fromDate='+this.SearchFromDate+'&toDate='+this.SearchToDate);
            }
  ...
  DateWiseSummaryReportBREBPostPaids(){
    ...
    return this.http.get(this.BaseConrtURI + 'DateWiseSummaryReportBREBPostPaids?date='+this.SearchFromDate);
  }

  MonthlySummaryReportBREBPostPaids(){
    ...
    return this.http.get(this.BaseConrtURI + 'MonthlySummaryReportBREBPostPaids?fromDate='+this.SearchFromDate);
  }
  MonthlyDatewiseReportBREBPostPaids(){
    ...
    return this.http.get(this.BaseConrtURI + 'MonthlyReportBREBPostpaids?date='+this.SearchFromDate);
  }
